          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-4" id="story-banner-text">
              ...
              <p className="font-sans font-normal text-[15px] sm:text-[16.5px] leading-relaxed text-white/80 max-w-2xl">
                Founded under Ahmedabad trust regulations, Gridaan set out with a simple goal: replacing manual record-keeping stacks with secure, simple digital interfaces. Today, we assist schools in securing operations, improving communication, and modernizing public branding.
              </p>
            </div>
              ...
              {CAPABILITIES.map((cap) => (
                ...
                >
                  <div>
                    ...
                    <h4 className="font-sans font-bold text-[11px] text-slate-500 tracking-[1.5px] uppercase mb-3.5 group-hover:text-brand-red transition-colors">
                      {cap.label}
                    </h4>
                  </div>
